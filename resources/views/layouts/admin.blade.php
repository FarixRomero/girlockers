    ...
    <body class="font-body antialiased bg-purple-darkest">
        <div class="min-h-screen flex">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                <!-- Top Navbar -->
                @if(!request()->routeIs('admin.lessons.create-global') && !request()->routeIs('admin.lessons.create') && !request()->routeIs('admin.lessons.edit'))
                ...
                <!-- Page Content -->
                <main class="flex-1 overflow-y-auto {{ request()->routeIs('admin.lessons.create-global') || request()->routeIs('admin.lessons.create') || request()->routeIs('admin.lessons.edit') ? 'p-0' : 'p-4 lg:p-8' }}">
                    @yield('content', $slot ?? '')
                </main>
            </div>
