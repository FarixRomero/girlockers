    ...
    <body class="font-body antialiased bg-white">
        <div class="flex h-screen overflow-hidden">
            ...
            <aside x-data="{ collapsed: false }" :class="collapsed ? 'w-20' : 'w-64'" class="hidden lg:flex lg:flex-col bg-gray-900 border-r border-gray-800 transition-all duration-300">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <!-- Librería (Cursos) -->
                    <a href="{{ route('courses.index') }}" wire:navigate class="sidebar-nav-item {{ request()->routeIs('courses.*') && !request()->routeIs('lessons.*') ? 'active' : '' }}" :class="collapsed ? 'justify-center' : ''" :title="collapsed ? 'Librería' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-light shadow-lg z-50">
            <div class="flex justify-around items-center px-2 py-3">
                ...
                <!-- Librería -->
                <a href="{{ route('courses.index') }}" wire:navigate class="flex flex-col items-center justify-center flex-1 space-y-1 {{ request()->routeIs('courses.*') && !request()->routeIs('lessons.*') ? 'text-purple-primary' : 'text-gray-dark' }} hover:text-purple-primary transition-colors">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                    </svg>
