        ...
        <div class="min-h-screen flex">
            ...
            <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-purple-darker border-r border-pink-vibrant/20">
                ...
                <nav class="flex-1 px-4 space-y-2">
                    ...
                    <a href="{{ route('admin.memberships') }}" wire:navigate class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.memberships') ? 'bg-pink-vibrant text-cream' : 'text-cream/70 hover:bg-purple-deep' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.profile') }}" wire:navigate class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.profile') ? 'bg-pink-vibrant text-cream' : 'text-cream/70 hover:bg-purple-deep' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                ...
                <!-- Page Content -->
                <main class="flex-1 overflow-y-auto pb-20 lg:pb-0 {{ request()->routeIs('admin.lessons.create-global') || request()->routeIs('admin.lessons.create') || request()->routeIs('admin.lessons.edit') || request()->routeIs('admin.courses.modules') || request()->routeIs('admin.modules.lessons') ? 'p-0' : 'p-4 lg:p-8' }}">
                    @yield('content', $slot ?? '')
                </main>
            </div>
            ...
            @if(!request()->routeIs('admin.lessons.create-global') && !request()->routeIs('admin.lessons.create') && !request()->routeIs('admin.lessons.edit') && !request()->routeIs('admin.courses.modules') && !request()->routeIs('admin.modules.lessons'))
                ...
                <div class="flex justify-around items-center">
                    ...
                    <a href="{{ route('admin.profile') }}" wire:navigate class="nav-item {{ request()->routeIs('admin.profile') ? 'active' : '' }}">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
